<template>
    <div class="bg-black flex flex-col justify-center items-center py-20 space-y-10 relative">
        <div>
            <img src="~/assets/img/cinze.png" class="w-[100px] invert brightness-0" alt="" />
        </div>
